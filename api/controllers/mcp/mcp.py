...
from models.model import App, AppMCPServer, AppMode, EndUser, load_annotation_reply_config
...
class MCPAppApi(Resource):
    ...
    def _get_user_input_form(self, app: App, *, session: Session) -> list[VariableEntity]:
        """Get and convert user input form using the caller-owned database session."""
